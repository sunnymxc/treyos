    ...
    <div class="row" data-aos="fade-up">
      ...
      <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
        <div class="count-box">
          ...
          <span data-toggle="counter-up">271</span>
          <p>Movements</p>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row content">
      ...
      <div class="col-md-8 pt-4" data-aos="fade-up">
        ...
        <a href="" class="btn btn-success mt-3 px-4">Book Us</a>
    ...
    <div class="row content">
      <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
        <img src="{{ asset('img/truck11.jpg') }}" class="img-fluid" alt="">
      </div>
      <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
        <h3>Excursion Services</h3>
        <p class="font-italic">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
          magna aliqua.
        </p>
  ...
  <section id="agents" class="pricing">
    <div class="container">
      ...
      <div class="row" data-aos="fade-left">
        ...
        <div class="col-lg-6 col-md-8 mt-4 mt-md-0 mx-auto">
